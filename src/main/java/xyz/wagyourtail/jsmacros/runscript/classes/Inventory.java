    ...
    public int getSlotUnderMouse() {
        ...
        try {
            ...
            if (FabricLoader.getInstance().isDevelopmentEnvironment()) {
                getSlot = ContainerScreen.class.getDeclaredMethod("getSlotAt", double.class, double.class);
            } else {
            }
                getSlot = ContainerScreen.class.getDeclaredMethod("method_2386", double.class, double.class);
