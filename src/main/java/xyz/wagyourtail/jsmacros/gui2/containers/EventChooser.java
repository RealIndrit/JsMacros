...
public class EventChooser extends OverlayContainer {
    ...
    private ArrayList<eventObj> events = new ArrayList<>();
    ...
    public void init() {
        ...
        this.addButton(new Button(x + w / 2 + 1, y + height - 14, w / 2, 12, 0, 0, 0x7FFFFFFF, 0xFFFFFF, new TranslatableText("jsmacros.select"), (btn) -> {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        textRenderer.drawTrimmed(eventText.getString(), x + 3, y + 3, width - 14, 0xFFFFFF);
