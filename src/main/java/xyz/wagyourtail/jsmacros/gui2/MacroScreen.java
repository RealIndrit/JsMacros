...
public class MacroScreen extends Screen {
    ...
    public void runFile(MacroListTopbar m) {
        openOverlay(new FileChooser(width / 4, height / 4, width / 2, height / 2, minecraft.textRenderer, jsMacros.config.macroFolder, this::addButton, this::removeButton, this::closeOverlay,(file) -> {
            try {
