...
public class MacroScreen extends Screen {
    ...
    protected void init() {
        ...
        topbar = new MacroListTopbar(this.width / 12, 25, this.width * 5 / 6, 14, minecraft.textRenderer, MacroEnum.KEY_RISING, this::addButton, this::addMacro, this::runFile);
    ...
    public void addMacro(RawMacro macro) {
        macros.add(new MacroContainer(this.width / 12, topScroll + macros.size() * 16, this.width * 5 / 6, 14, minecraft.textRenderer, macro, this::addButton, this::confirmRemoveMacro, this::setFile, this::setEvent));
    ...
    public void setEvent(MacroContainer macro) {
        openOverlay(new EventChooser(width / 4, height / 4, width / 2, height / 2, minecraft.textRenderer, macro.getRawMacro().eventkey, this::addButton, this::removeButton, this::closeOverlay, macro::setEventType));
    }
